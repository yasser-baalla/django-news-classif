...
def nlp(url) :
    ...
    f2 = open("json\\" + cell2,"w",encoding="utf-8")
    for text in f :
        #print(text)
    ...
    f = open("json\\" + cell2,"r",encoding="utf-8")
    for text in f :
        #print(text)
        text2 = tokenize(text)
        #print(type(text2))
    with open("json\\" + cell3,"w",encoding="utf-8") as f3 :
        json.dump(text2,f3,ensure_ascii=False)
    with open("json\\" + cell3,"r",encoding="utf-8") as f3 :
        lists = json.load(f3)
        lists_no_stopwords = remove_stopwords(lists)
    with open("json\\" + cell4,"w",encoding="utf-8") as f4 :
        json.dump(lists_no_stopwords,f4,ensure_ascii=False)
    with open("json\\" + cell4,"r",encoding="utf-8") as f4 :
        lists_no_stopwords = json.load(f4)
    f.close()
    os.remove("json\\" + cell3)
    os.remove("json\\" + cell2)
    cell4 = url.replace('.txt','_nostopwords.json')
    ...
    with open("json\\" + cell4,"r",encoding="utf-8") as f4 :
        ...
        #print(lists_stemmed)
    with open("json\\" + cell5,"w",encoding="utf-8") as f5 :
        json.dump(lists_stemmed,f5,ensure_ascii=False)
    with open("json\\" + cell5,"r",encoding="utf-8") as f5 :
        lists_stemmed = json.load(f5)
    os.remove("json\\" + cell4)
