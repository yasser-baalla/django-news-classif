...
class category_info(models.Model):
    ...
    revue_presse = models.BooleanField(default=False) 
    revue_web = models.BooleanField(default=False)
    ...
    loi_décret = models.BooleanField(default=False)
    terrorisme = models.BooleanField(default=False)
    meteo = models.BooleanField(default=False)
    blessures = models.BooleanField(default=False)
